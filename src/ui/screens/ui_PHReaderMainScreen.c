...
void ui_PHReaderMainScreen_screen_init(void)
{
    ...
    lv_obj_set_width(ui_mainTabView, 315);
    lv_obj_set_height(ui_mainTabView, 235);
    lv_obj_set_x(ui_mainTabView, -1);
    lv_obj_set_y(ui_mainTabView, 0);
    ...
    ui_pHValLabel = lv_label_create(ui_pHReader);
    ...
    lv_obj_set_y(ui_pHValLabel, lv_pct(-25));
    ...
    ui_tempStaticLabel = lv_label_create(ui_pHReader);
    ...
    lv_obj_set_y(ui_tempStaticLabel, lv_pct(10));
    ...
    ui_tempValLabel = lv_label_create(ui_pHReader);
    ...
    lv_obj_set_y(ui_tempValLabel, lv_pct(10));
    ...
    ui_PHStaticLabel = lv_label_create(ui_pHReader);
    lv_obj_set_width(ui_PHStaticLabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_PHStaticLabel, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_PHStaticLabel, -88);
    lv_obj_set_y(ui_PHStaticLabel, lv_pct(-25));
    ...
    lv_obj_set_y(ui_celciusSwitchLabel, 70);
    ...
    lv_obj_set_y(ui_fahrenheitSwitchLabel, 70);
    ...
    lv_obj_set_y(ui_tempUnitsSwitch, 70);
    ...
    lv_obj_set_style_bg_color(ui_tempUnitsSwitch, lv_color_hex(0x000000), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_tempUnitsSwitch, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_tempUnitsSwitch, lv_color_hex(0xFFFFFF), LV_PART_KNOB | LV_STATE_DEFAULT);
    ...
    lv_obj_set_height(ui_chartTabView, 192);
    lv_obj_set_x(ui_chartTabView, 1);
    lv_obj_set_y(ui_chartTabView, 0);
    ...
    lv_obj_set_height(ui_pHChart, 115);
    lv_obj_set_x(ui_pHChart, 1);
    ...
    lv_chart_series_t * ui_pHChart_series_1 = lv_chart_add_series(ui_pHChart, lv_color_hex(0x808080),
    ...
    lv_obj_set_height(ui_tempChart, 115);
    ...
    lv_obj_set_width(ui_startWebpageButton, 140);
    lv_obj_set_height(ui_startWebpageButton, 59);
    lv_obj_set_x(ui_startWebpageButton, -77);
    lv_obj_set_y(ui_startWebpageButton, 57);
    ...
    lv_obj_set_y(ui_plotTimePeriodDropdown, -42);
    ...
    lv_obj_set_y(ui_plotTimePeriodLabel, -42);
    ...
    lv_obj_set_y(ui_samplingIntervalDropdown, -80);
    ...
    lv_obj_set_y(ui_samplingIntervalLabel, -79);
    ...
    lv_obj_set_width(ui_warningLabel, lv_pct(100));
    ...
    lv_obj_set_width(ui_startBluetoothButton, 141);
    lv_obj_set_height(ui_startBluetoothButton, 59);
    lv_obj_set_x(ui_startBluetoothButton, 74);
    lv_obj_set_y(ui_startBluetoothButton, 57);
